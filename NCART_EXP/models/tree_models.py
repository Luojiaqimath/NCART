...
class XGBoost(BaseModel):
    ...
    def fit(self, X, y, X_val=None, y_val=None):
        ...
        eval_list = [(val, "eval")]
        self.model = xgb.train(self.params, train,
    ...
    def define_trial_parameters(cls, trial, args):
        params = {
            ...
            "lambda": trial.suggest_float("lambda", 0.5, 2.0, log=True),
...
class CatBoost(BaseModel):
    ...
    def __init__(self, params, args):
        ...
        if args.use_gpu:
            ...
            self.params["devices"] = str(args.gpu_ids[0])
            # self.params["gpu_ram_part"] = 0.5
...
class LightGBM(BaseModel):
    ...
    def __init__(self, params, args):
        ...
        if args.use_gpu:
            ...
            self.params["gpu_platform_id"] = args.gpu_ids[0]
            self.params["gpu_device_id"] = args.gpu_ids[0]
    ...
    def fit(self, X, y, X_val=None, y_val=None):
        ...
        self.model = lgb.train(self.params, train, num_boost_round=self.args.epochs,
                               valid_sets=[val],
                               callbacks=[lgb.early_stopping(stopping_rounds=self.args.early_stopping_rounds)],
